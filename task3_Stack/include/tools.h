...
//--------------------------------------------------------------------------------------------
#define message( color, phrase )	{color; printf(phrase); reset_color;}


//--------------------------------------------------------------------------------------------
//! @def messagen( color, phrase )
//! Prints phrase in color.
//!
//! @param[in]	color	Color used in print from defined macros, e.g. red, yellow, etc.
//! @param[in]	phrase	Phrase to be printed.
//--------------------------------------------------------------------------------------------
#define messagen( color, phrase )	{color; printf(phrase"\n"); reset_color;}
